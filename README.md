...
A standalone sampler extension for Forge-derived WebUIs that ports all ODE solver
methods from [ComfyUI-RK-Sampler](https://github.com/memmaptensor/ComfyUI-RK-Sampler).
...
**torchode** must be installed before use:
...
Forge 派生 WebUI 向けの独立したサンプラー拡張として、
...
| `ae_dopri5` | Dormand–Prince | 5 | 6 | 最も広く使われる適応 ODE ソルバー（≈ scipy RK45）。 |
